...
namespace ConsoleApp1Project.core
{
    ...
    public class PHandler<I, O>
    {
        ...
        // delegado y método asociado para dividir la entrada en varias entradas
        ...
        // delegado y método asociado para unir las salidas en una única
        ...
        // delegado y método que se ejecuta en la tarea para producir una salida a partir de una entrada
    ...
    namespace test
    {
        ...
        public static class Metodos
        {
            public static List<CustomInput> dividirEntrada(CustomInput input, int parts)
            {
                ...
                int blockSize = Math.Max(2, input.Numeros.Count / parts);
            ...
            public static void testPHandler()
            {
                ...
                phandler.InputPartsCount = HILOS;
